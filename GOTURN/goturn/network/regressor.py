...
class regressor:
    ...
    def __init__(self, deploy_proto, caffe_model, gpu_id, num_inputs,
            do_train=False, logger=None, solver_file=None):
        """TODO: to be defined"""
    ...
    def setupNetwork(self, deploy_proto, caffe_model, gpu_id, do_train):
        ...
        if do_train == True:
            ...
            print ('INFO: Setting phase to train')
            ...
            if self.solver_file:
                ...
                print ('ERROR: solver file required')
                return

            self.phase = caffe.TRAIN
        else:
            # logger.info('Setting phase to test')
            print ('INFO: Setting phase to test')
        ...
        if self.num_inputs != 1:
            ...
            print('ERROR: Network should take exactly one input')
        if self.channels != 1 and self.channels != 3:
            # logger.error('Network should have 1 or 3 channels')
            print('ERROR: Network should have 1 or 3 channels')
